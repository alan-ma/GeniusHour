...
var posts = [
	...
	},
	{
		...
		title: "Vector Class",
		date: "Oct. 25, 2016",
		content: "Based on the code from the guide, I've created a simple vector class that allows for vector manipulation. I had a bit of knowledge on matrices and vectors from the Machine Learning " + addlink('https://www.coursera.org/learn/machine-learning', 'course') + " that I did last year (although I have yet to finish the last few weeks that talk about unsupervised learning). Anyways, the lienar algebra review in that course didn't go over vector cross product and rotation, so I watched " + addlink('https://www.youtube.com/watch?v=pJzmiywagfY', 'these') + " " + addlink('https://www.youtube.com/watch?v=lPWfIq5DzqI', 'videos') + " to understand Kanber's code (thanks Khan Academy). <br> The code: </p>	" + '<iframe width="100%" height="300" src="<iframe width="100%" height="300" src="//jsfiddle.net/alan_ma/k6nkfdzc/embedded/js/dark/" allowfullscreen="allowfullscreen" frameborder="0"></iframe>' + "<p>So after a good amount of contemplation, I now finally understand Kanber's rotation function and it's SO AMAZING. It allows you to rotate one point around another, so yay! Here's a " + addimg('https://gyazo.com/6215a31f4a77c4da949f8ca3311fa869','picture') + "of one vecotor (blue) being rotate around a certain point (not shown) to become another vector (red). The rotation about the point is shown in green. Vectors are great :D",
		date: "Oct. 28, 2016",
	},
	{
		id: 4,
